#ifndef NETCOM_PACKETS_F123_INCLUDE_CAR_TELEMETRY_DATA_H_
#define NETCOM_PACKETS_F123_INCLUDE_CAR_TELEMETRY_DATA_H_
...
namespace Packet {
    ...
    namespace F1_23 {
        ...
        class CarTelemetryData final : public Packet::F1_23::IPacket {

        public:
            CarTelemetryData(const char* packetInfo, const Header* header, Packet::Helper* helper);
...
#endif  // NETCOM_PACKETS_F123_INCLUDE_CAR_TELEMETRY_DATA_H_