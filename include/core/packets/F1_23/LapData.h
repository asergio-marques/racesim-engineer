#ifndef NETCOM_PACKETS_F123_INCLUDE_LAP_DATA_H_
#define NETCOM_PACKETS_F123_INCLUDE_LAP_DATA_H_
...
namespace Packet {
    ...
    namespace F1_23 {
        ...
        class LapData final : public Packet::F1_23::IPacket {

            public:
            LapData(const char* packetInfo, const Header* header, Packet::Helper* helper);
            ~LapData() = default;
            ...
            Packet::F1_23::LapInfo m_lapData[22];
...
#endif // NETCOM_PACKETS_F123_INCLUDE_LAP_DATA_H_