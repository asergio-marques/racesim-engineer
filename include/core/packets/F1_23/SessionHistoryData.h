#ifndef NETCOM_PACKETS_F123_INCLUDE_SESSION_HISTORY_DATA_H_
#define NETCOM_PACKETS_F123_INCLUDE_SESSION_HISTORY_DATA_H_
...
namespace Packet {
    ...
    namespace F1_23 {
        ...
        class SessionHistoryData final : public Packet::F1_23::IPacket {

        public:
            SessionHistoryData(const char* packetInfo, const Header* header, Packet::Helper* helper);
            ...
            inline const Packet::F1_23::LapHistoryInfo* const GetLapHistoryInfo() const { return m_lapHistoryInfo; }
            inline const Packet::F1_23::LapHistoryInfo* const GetCurrentLapInfo() const { return &m_lapHistoryInfo[GetNumLaps()]; }
            inline const Packet::F1_23::TyreStintHistoryInfo* const GetTyreStintHistoryInfo() const { return m_tyreStintHistoryInfo; }
            inline const Packet::F1_23::TyreStintHistoryInfo* const GetCurrentTyreStintInfo() const { return &m_tyreStintHistoryInfo[GetNumLaps()]; }
...
#endif  // NETCOM_PACKETS_F123_INCLUDE_SESSION_HISTORY_DATA_H_