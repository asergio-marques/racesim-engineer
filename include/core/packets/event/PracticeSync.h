#ifndef PACKETS_EVENT_INCLUDE_PRACTICE_SYNC_H_
#define PACKETS_EVENT_INCLUDE_PRACTICE_SYNC_H_
...
namespace Packet {
    ...
    namespace Event {
        ...
        struct PracticeSync : public Packet::Event::Interface {
            ...
            std::vector<Packet::Event::PracticeSync::ParticipantData> m_participants;
...
#endif  //  PACKETS_EVENT_INCLUDE_PRACTICE_SYNC_H_