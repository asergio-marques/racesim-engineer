#ifndef PACKETS_GAME_F123_INCLUDE_CAR_SETUP_DATA_H_
#define PACKETS_GAME_F123_INCLUDE_CAR_SETUP_DATA_H_
    ...
    namespace Game {
        ...
        namespace F1_23 {
            ...
            class CarSetupData final : public Packet::Game::F1_23::Interface {
                ...
                const Packet::Game::F1_23::CarSetupInfo GetSetupInfo(const size_t index, bool& ok) const;
...
#endif  // PACKETS_GAME_F123_INCLUDE_CAR_SETUP_DATA_H_