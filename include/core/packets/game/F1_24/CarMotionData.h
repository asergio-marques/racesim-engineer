#ifndef PACKETS_GAME_F124_INCLUDE_CAR_MOTION_DATA_H_
#define PACKETS_GAME_F124_INCLUDE_CAR_MOTION_DATA_H_
...
namespace Packet {
    ...
    namespace Game {
        ...
        namespace F1_24 {
            ...
            class CarMotionData final : public Packet::Game::F1_24::Interface {
                ...
                const Packet::Game::F1_24::CarMotionInfo GetCarMotionInfo(const size_t index, bool& ok) const;
...
#endif  // PACKETS_GAME_F124_INCLUDE_CAR_MOTION_DATA_H_