#ifndef PACKETS_GAME_F124_INCLUDE_CAR_STATUS_DATA_H_
#define PACKETS_GAME_F124_INCLUDE_CAR_STATUS_DATA_H_
    ...
    namespace Game {
        ...
        namespace F1_24 {
            ...
            struct CarStatusInfo {
                ...
                Status::Game::F1_24::ActualTyreCompound m_actualTyres;

                // The visual display/tier of compound the vehicle has on currently
                Status::Game::F1_24::VisualTyreCompound m_visualTyres;

                // Age in laps of the current set of tyres
                uint8_t m_tyreLaps;

                // Flag currently active for this vehicle
                Session::Game::F1_24::ActiveFlag m_vehicleFlags;
                ...
                Status::Game::F1_24::ERSDeploymentMode m_ersDeployMode;
            ...
            class CarStatusData final : public Packet::Game::F1_24::Interface {
                ...
                const Packet::Game::F1_24::CarStatusInfo GetCarStatusInfo(const size_t index, bool& ok) const;
...
#endif  // PACKETS_GAME_F124_INCLUDE_CAR_STATUS_DATA_H_