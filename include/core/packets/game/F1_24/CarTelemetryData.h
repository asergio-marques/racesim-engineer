#ifndef PACKETS_GAME_F124_INCLUDE_CAR_TELEMETRY_DATA_H_
#define PACKETS_GAME_F124_INCLUDE_CAR_TELEMETRY_DATA_H_
    ...
    namespace Game {
        ...
        namespace F1_24 {
            ...
            struct CarTelemetryInfo {
                ...
                Telemetry::Game::F1_24::Gear m_gear;
                ...
                Telemetry::Game::F1_24::Surface m_surfaceType[4];
            ...
            class CarTelemetryData final : public Packet::Game::F1_24::Interface {
                ...
                const Packet::Game::F1_24::CarTelemetryInfo GetCarTelemetryInfo(const size_t index, bool& ok) const;
                inline const Telemetry::Game::F1_24::MFDPanel GetMFDPanelPlayer1() const { return m_mfdPanelPlayer1; }
                inline const Telemetry::Game::F1_24::MFDPanel GetMFDPanelPlayer2() const { return m_mfdPanelPlayer2; }
                inline const Telemetry::Game::F1_24::Gear GetSuggestedGearPlayer1() const { return m_suggestedGearPlayer1; }
                ...
                Telemetry::Game::F1_24::MFDPanel m_mfdPanelPlayer1;

                // Index of MFD panel player 1 has open currently
                Telemetry::Game::F1_24::MFDPanel m_mfdPanelPlayer2;

                // Suggested gear for player 1, Neutral is to be interpreted as no suggestion
                Telemetry::Game::F1_24::Gear m_suggestedGearPlayer1;
...
#endif  // PACKETS_GAME_F124_INCLUDE_CAR_TELEMETRY_DATA_H_