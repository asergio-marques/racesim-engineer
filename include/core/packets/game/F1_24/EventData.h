#ifndef PACKETS_GAME_F124_INCLUDE_EVENT_DATA_H_
#define PACKETS_GAME_F124_INCLUDE_EVENT_DATA_H_
    ...
    namespace Game {
        ...
        namespace F1_24 {
            ...
            struct PenaltyEvent {
                ...
                // Penalty awarded
                Event::F1_24::PenaltyType m_penaltyType;

                // Reason for the penalty being awarded
                Event::F1_24::InfringementType m_infringementType;
            ...
            struct ButtonEvent {
                ...
                Event::F1_24::ButtonBitMask m_buttonStatus;
            ...
            class EventData final : public Packet::Game::F1_24::Interface {
                ...
                inline const Event::F1_24::Type& GetEventType() const { return m_eventType; }
                ...
                static std::map<std::string, Event::F1_24::Type> m_eventCodeTable;
...
#endif  // PACKETS_GAME_F124_INCLUDE_EVENT_DATA_H_