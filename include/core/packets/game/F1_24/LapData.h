#ifndef PACKETS_GAME_F124_INCLUDE_LAP_DATA_H_
#define PACKETS_GAME_F124_INCLUDE_LAP_DATA_H_
    ...
    namespace Game {
        ...
        namespace F1_24 {
            ...
            struct LapInfo {
                ...
                Lap::Game::F1_24::VehicleStatus m_status;

                // Vehicle result in the session
                Lap::Game::F1_24::ResultStatus m_result;
            ...
            class LapData final : public Packet::Game::F1_24::Interface {
                ...
                const Packet::Game::F1_24::LapInfo GetLapInfo(const size_t index, bool& ok) const;
                ...
                Packet::Game::F1_24::LapInfo m_lapData[22];
...
#endif // PACKETS_GAME_F124_INCLUDE_LAP_DATA_H_