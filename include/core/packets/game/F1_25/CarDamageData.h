#ifndef PACKETS_GAME_F125_INCLUDE_CAR_DAMAGE_DATA_H_
#define PACKETS_GAME_F125_INCLUDE_CAR_DAMAGE_DATA_H_
...
namespace Packet {
    ...
    namespace Game {
        ...
        namespace F1_25 {
            ...
            class CarDamageData final : public Packet::Game::F1_25::Interface {
                ...
                const Packet::Game::F1_25::CarDamageInfo GetCarDamageInfo(const size_t index, bool& ok) const;
...
#endif  // PACKETS_GAME_F125_INCLUDE_CAR_DAMAGE_DATA_H_