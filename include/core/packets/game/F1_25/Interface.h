#ifndef PACKETS_GAME_F125_INCLUDE_INTERFACE_H_
#define PACKETS_GAME_F125_INCLUDE_INTERFACE_H_
    ...
    namespace Game {
        ...
        namespace F1_25 {
            ...
            class Interface : public Packet::Game::Interface {
                ...
                virtual const Packet::Game::F1_25::LengthBytes GetLength() const;
...
#endif  //  PACKETS_GAME_F125_INCLUDE_INTERFACE_H_