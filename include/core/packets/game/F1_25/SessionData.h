#ifndef PACKETS_GAME_F125_INCLUDE_SESSION_DATA_H_
#define PACKETS_GAME_F125_INCLUDE_SESSION_DATA_H_
...
namespace Packet {
    ...
    namespace Game {
        ...
        namespace F1_25 {
            ...
            class SessionData final : public Packet::Game::F1_25::Interface {
                ...
                inline const Session::Game::F1_25::Type GetSessionType() const { return m_sessionType;}
                inline const Session::Game::F1_25::Track GetTrackId() const { return m_trackId;}
                inline const Session::Game::F1_25::Formula GetFormula() const { return m_formula;}
                ...
                inline const Session::Game::F1_25::SafetyCar GetSafetyCarStatus() const { return m_safetyCarStatus;}
                ...
                inline const Player::Game::F1_25::BrakingAssist GetBrakingAssist() const { return m_brakingAssist;}
                inline const Player::Game::F1_25::GearboxAssist GetGearboxAssist() const { return m_gearboxAssist;}
                ...
                inline const Player::Game::F1_25::RacingLine GetDynamicRacingLine() const { return m_dynamicRacingLine;}
                inline const bool GetDynamicRacingLine3D() const { return m_dynamicRacingLine3D;}
                inline const Session::Game::F1_25::GameMode GetGameMode() const { return m_gameMode;}
                inline const Session::Game::F1_25::Ruleset GetRuleSet() const { return m_ruleSet;}
                inline const uint32_t GetTimeOfDay() const { return m_timeOfDay;}
                inline const Session::Game::F1_25::Length GetSessionLength() const { return m_sessionLength;}
                inline const Player::Game::F1_25::SpeedUnit GetSpeedUnitPlayer1() const { return m_speedUnitPlayer1;}
                inline const Player::Game::F1_25::TempUnit GetTempUnitPlayer1() const { return m_tempUnitPlayer1;}
                inline const Player::Game::F1_25::SpeedUnit GetSpeedUnitPlayer2() const { return m_speedUnitPlayer2;}
                inline const Player::Game::F1_25::TempUnit GetTempUnitPlayer2() const { return m_tempUnitPlayer2;}
                ...
                inline const Session::Game::F1_25::EventRate4State GetCarDamage() const { return m_carDamage; }
                inline const Session::Game::F1_25::EventRate3State GetCarDamageRate() const { return m_carDamageRate; }
                inline const Session::Game::F1_25::CollisionSetting GetCollisions() const { return m_collisions; }
                ...
                inline const Session::Game::F1_25::Type* GetWeekendStructure() const { return m_weekendStructure; }
                ...
                // Current weather
                Session::Game::F1_25::Weather m_currentWeather;
                ...
                Session::Game::F1_25::Track m_trackId;

                // Type of cars in the current session
                Session::Game::F1_25::Formula m_formula;
                ...
                Session::Game::F1_25::SafetyCar m_safetyCarStatus;
                ...
                Player::Game::F1_25::BrakingAssist m_brakingAssist;

                // Level of gearbox assist the player has on
                Player::Game::F1_25::GearboxAssist m_gearboxAssist;
                ...
                Player::Game::F1_25::RacingLine m_dynamicRacingLine;

                // Whether the racing line assist is 3D
                bool m_dynamicRacingLine3D;

                // Game mode for the current session
                Session::Game::F1_25::GameMode m_gameMode;

                // Ruleset for the current session
                Session::Game::F1_25::Ruleset m_ruleSet;

                // Local time of day (minutes past midnight)
                uint32_t m_timeOfDay;

                // Length of the current session
                Session::Game::F1_25::Length m_sessionLength;

                // Speed unit used by Player 1
                Player::Game::F1_25::SpeedUnit m_speedUnitPlayer1;

                // Temperature unit used by Player 1
                Player::Game::F1_25::TempUnit m_tempUnitPlayer1;

                // Speed unit used by Player 2
                Player::Game::F1_25::SpeedUnit m_speedUnitPlayer2;

                // Temperature unit used by Player 2
                Player::Game::F1_25::TempUnit m_tempUnitPlayer2;
                ...
                Session::Game::F1_25::EventRate4State m_carDamage;
                
                // Rate at which car damage occurs following a collision
                Session::Game::F1_25::EventRate3State m_carDamageRate;
                
                // Whether car collisions are enabled and what limits there are to collisions
                Session::Game::F1_25::CollisionSetting m_collisions;
                ...
                Session::Game::F1_25::ExperienceSetting m_pitStopSetting;
                ...
                Session::Game::F1_25::Type m_weekendStructure[12];
...
#endif  // PACKETS_GAME_F125_INCLUDE_SESSION_DATA_H_