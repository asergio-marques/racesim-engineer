#ifndef PACKETS_GAME_F125_INCLUDE_SESSION_HISTORY_DATA_H_
#define PACKETS_GAME_F125_INCLUDE_SESSION_HISTORY_DATA_H_
    ...
    namespace Game {
        ...
        namespace F1_25 {
            ...
            struct TyreStintHistoryInfo {
                ...
                Status::Game::F1_25::ActualTyreCompound m_tyreActualCompound;

                // The visual display/tier of compound that corresponds to this struct
                Status::Game::F1_25::VisualTyreCompound m_tyreVisualCompound;
            ...
            class SessionHistoryData final : public Packet::Game::F1_25::Interface {
                ...
                inline const Packet::Game::F1_25::LapHistoryInfo* const GetLapHistoryInfo() const { return m_lapHistoryInfo; }
...
#endif  // PACKETS_GAME_F125_INCLUDE_SESSION_HISTORY_DATA_H_