#ifndef PACKETS_GAME_F125_INCLUDE_TYRE_SET_DATA_H_
#define PACKETS_GAME_F125_INCLUDE_TYRE_SET_DATA_H_
    ...
    namespace Game {
        ...
        namespace F1_25 {
            ...
            struct TyreSetInfo {
                ...
                Status::Game::F1_25::ActualTyreCompound m_actualTyreCompound;

                // Visual tyre compound of the set
                Status::Game::F1_25::VisualTyreCompound m_visualTyreCompound;
                ...
                Session::Game::F1_25::Type m_recommendedSession;
            ...
            class TyreSetData final : public Packet::Game::F1_25::Interface {
                ...
                const Packet::Game::F1_25::TyreSetInfo* const GetTyreSetInfo() const { return m_tyreSets; }
...
#endif  // PACKETS_GAME_F125_INCLUDE_TYRE_SET_DATA_H_