#ifndef NETCOM_PACKETS_F123_INCLUDE_CAR_DAMAGE_DATA_H_
#define NETCOM_PACKETS_F123_INCLUDE_CAR_DAMAGE_DATA_H_
...
namespace Packet {
    ...
    namespace F1_23 {
        ...
        class CarDamageData final : public Packet::F1_23::IPacket {

            public:
            CarDamageData(const char* packetInfo, const Header* header, Packet::Helper* helper);
            ...
            const Packet::F1_23::CarDamageInfo GetCarDamageInfo(const size_t index, bool& ok) const;
...
#endif  // NETCOM_PACKETS_F123_INCLUDE_CAR_DAMAGE_DATA_H_