#ifndef NETCOM_PACKETS_F123_INCLUDE_CAR_MOTION_DATA_H_
#define NETCOM_PACKETS_F123_INCLUDE_CAR_MOTION_DATA_H_
...
namespace Packet {
    ...
    namespace F1_23 {
        ...
        class CarMotionData final : public Packet::F1_23::IPacket {

        public:
            CarMotionData(const char* packetInfo, const Header* header, Packet::Helper* helper);
            ...
            const Packet::F1_23::CarMotionInfo GetCarMotionInfo(const size_t index, bool& ok) const;
...
#endif  // NETCOM_PACKETS_F123_INCLUDE_CAR_MOTION_DATA_H_