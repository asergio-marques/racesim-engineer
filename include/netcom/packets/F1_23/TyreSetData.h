#ifndef NETCOM_PACKETS_F123_INCLUDE_TYRE_SET_DATA_H_
#define NETCOM_PACKETS_F123_INCLUDE_TYRE_SET_DATA_H_
...
namespace Packet {
    ...
    namespace F1_23 {
        ...
        class TyreSetData final : public Packet::F1_23::IPacket {

        public:
            TyreSetData(const char* packetInfo, const Header* header, Packet::Helper* helper);
            ~TyreSetData() = default;
            ...
            const Packet::F1_23::TyreSetInfo* const GetTyreSetInfo() const { return m_tyreSets; }
...
#endif  // NETCOM_PACKETS_F123_INCLUDE_TYRE_SET_DATA_H_