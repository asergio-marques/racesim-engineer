...
Packet::Game::F1_24::Header::Header(const char* packetInfo, Packet::Game::Helper* helper) :
    m_packetFormat(0), 
    m_gameYear(0),
    m_gameMajorVersion(0),
    m_gameMinorVersion(0),
    m_packetVersion(0),
    m_packetType(Packet::Game::F1_24::Type::InvalidUnknown),
    m_sessionUID(0),
    m_sessionTime(0.0f),
    m_frameIdentifier(0),
    ...
    if (packetInfo && helper) {
        ...
        helper->SetPacketLength(static_cast<size_t>(Packet::Game::F1_24::LengthBytes::Header));
...
const bool Packet::Game::F1_24::Header::IsWellFormed() const {

    if ((GetPacketFormat() == 2024) &&
        (GetGameYear() == 0x18) &&
        (GetPacketVersion() > 0) &&
        (GetPacketType() != Packet::Game::F1_24::Type::InvalidUnknown)) {
...
#ifndef NDEBUG
void Packet::Game::F1_24::Header::Print() const {
