...
Packet::Game::F1_24::TimeTrialData::TimeTrialData(const char* packetInfo, const Header* header, Packet::Game::Helper* helper) :
...
const Packet::Game::F1_24::LengthBytes Packet::Game::F1_24::TimeTrialData::GetLength() const {

    return Packet::Game::F1_24::LengthBytes::TimeTrialData;
...
#ifndef NDEBUG
void Packet::Game::F1_24::TimeTrialData::Print() const {
...
void Packet::Game::F1_24::TimeTrialData::BuildPacket(const char* packetInfo, Packet::Game::Helper* helper) {
