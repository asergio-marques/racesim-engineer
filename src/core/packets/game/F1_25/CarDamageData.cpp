...
Packet::Game::F1_25::CarDamageData::CarDamageData(const char* packetInfo, const Header* header, Packet::Game::Helper* helper) :
...
const Packet::Game::F1_25::LengthBytes Packet::Game::F1_25::CarDamageData::GetLength() const {
...
const Packet::Game::F1_25::CarDamageInfo Packet::Game::F1_25::CarDamageData::GetCarDamageInfo(const size_t index, bool& ok) const {
    ...
    ok = false;
    return Packet::Game::F1_25::CarDamageInfo();
...
#ifndef NDEBUG
void Packet::Game::F1_25::CarDamageData::Print() const {
...
void Packet::Game::F1_25::CarDamageData::BuildPacket(const char* packetInfo, Packet::Game::Helper* helper) {
