...
Packet::Game::F1_25::CarStatusData::CarStatusData(const char* packetInfo, const Header* header, Packet::Game::Helper* helper) :
...
const Packet::Game::F1_25::LengthBytes Packet::Game::F1_25::CarStatusData::GetLength() const {

    return Packet::Game::F1_25::LengthBytes::CarStatusData;

}



const Packet::Game::F1_25::CarStatusInfo Packet::Game::F1_25::CarStatusData::GetCarStatusInfo(const size_t index, bool& ok) const {
    ...
    ok = false;
    return Packet::Game::F1_25::CarStatusInfo();
...
#ifndef NDEBUG
void Packet::Game::F1_25::CarStatusData::Print() const {
...
void Packet::Game::F1_25::CarStatusData::BuildPacket(const char* packetInfo, Packet::Game::Helper* helper) {
