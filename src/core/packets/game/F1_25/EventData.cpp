...
std::map<std::string, Event::F1_25::Type> Packet::Game::F1_25::EventData::m_eventCodeTable = {

    { std::string("SSTA"), Event::F1_25::Type::SessionStarted },
    { std::string("SEND"), Event::F1_25::Type::SessionEnded },
    { std::string("FTLP"), Event::F1_25::Type::FastestLapSet },
    { std::string("RTMT"), Event::F1_25::Type::CarRetired },
    { std::string("DRSE"), Event::F1_25::Type::DRSEnabled },
    { std::string("DRSD"), Event::F1_25::Type::DRSDisabled },
    { std::string("TMPT"), Event::F1_25::Type::TeammateInPits },
    { std::string("CHQF"), Event::F1_25::Type::ChequeredFlagWaved },
    { std::string("RCWN"), Event::F1_25::Type::RaceWinnerDecided },
    { std::string("PENA"), Event::F1_25::Type::PenaltyIssued },
    { std::string("SPTP"), Event::F1_25::Type::SpeedTrapTriggered },
    { std::string("STLG"), Event::F1_25::Type::StartLightsOn },
    ...
    { std::string("SCAR"), Event::F1_25::Type::SafetyCarActivated },
    { std::string("COLL"), Event::F1_25::Type::CollisionOccurred }

};



Packet::Game::F1_25::EventData::EventData(const char* packetInfo, const Packet::Game::F1_25::Header* header, Packet::Game::Helper* helper) :
    Packet::Game::F1_25::Interface(),
    m_eventType(Event::F1_25::Type::InvalidUnknown),
    m_fastestLapData(),
    m_carRetirementData(),
...
const Packet::Game::F1_25::LengthBytes Packet::Game::F1_25::EventData::GetLength() const {

    return Packet::Game::F1_25::LengthBytes::EventData;
...
#ifndef NDEBUG
void Packet::Game::F1_25::EventData::Print() const {
    std::cout << "--------------------------------------------" << std::endl;
    ...
    switch (m_eventType) {
        ...
        case Event::F1_25::Type::OvertakePerformed:
...
void Packet::Game::F1_25::EventData::BuildPacket(const char* packetInfo, Packet::Game::Helper* helper) {
    ...
    switch (m_eventType) {
        ...
        case Event::F1_25::Type::InvalidUnknown:
            // TODO error handling
            break;

        case Event::F1_25::Type::FastestLapSet:
            helper->getVariableFromByteStream<>(packetInfo, &m_fastestLapData, arrayStatus);
            break;

        case Event::F1_25::Type::CarRetired:
        ...
        case Event::F1_25::Type::SafetyCarActivated:
            helper->getVariableFromByteStream<>(packetInfo, &m_safetyCarData, arrayStatus);
            break;

        case Event::F1_25::Type::CollisionOccurred:
