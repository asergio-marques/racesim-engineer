...
Packet::Game::F1_25::LapData::LapData(const char* packetInfo, const Header* header, Packet::Game::Helper* helper) :
...
const Packet::Game::F1_25::LengthBytes Packet::Game::F1_25::LapData::GetLength() const {

    return Packet::Game::F1_25::LengthBytes::LapData;

}



const Packet::Game::F1_25::LapInfo Packet::Game::F1_25::LapData::GetLapInfo(const size_t index, bool& ok) const {
    ...
    ok = false;
    return Packet::Game::F1_25::LapInfo();
...
#ifndef NDEBUG
void Packet::Game::F1_25::LapData::Print() const {
...
void Packet::Game::F1_25::LapData::BuildPacket(const char* packetInfo, Packet::Game::Helper* helper) {
