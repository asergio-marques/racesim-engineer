...
Packet::Game::F1_25::SessionData::SessionData(const char* packetInfo, const Packet::Game::F1_25::Header* header, Packet::Game::Helper* helper) :
    Packet::Game::F1_25::Interface(),
    m_currentWeather(Session::Game::F1_25::Weather::InvalidUnknown),
    m_currentTrackTemperature(0),
    m_currentAirTemperature(0),
    m_totalLaps(0),
    m_trackLength(0),
    m_sessionType(Session::Game::F1_25::Type::InvalidUnknown),
    m_trackId(Session::Game::F1_25::Track::InvalidUnknown),
    m_formula(Session::Game::F1_25::Formula::InvalidUnknown),
    m_sessionTimeLeft(0),
    m_sessionDuration(0),
    m_pitSpeedLimit(0),
    m_gamePaused(false),
    ...
    m_numMarshalZones(0),
    m_marshalZones(),
    m_safetyCarStatus(Session::Game::F1_25::SafetyCar::InvalidUnknown),
    m_isNetwork(false),
    ...
    m_brakingAssist(Player::Game::F1_25::BrakingAssist::InvalidUnknown),
    m_gearboxAssist(Player::Game::F1_25::GearboxAssist::InvalidUnknown),
    m_pitAssistOn(false),
    m_pitReleaseAssistOn(false),
    m_ERSAssistOn(false),
    m_DRSAssistOn(false),
    m_dynamicRacingLine(Player::Game::F1_25::RacingLine::InvalidUnknown),
    m_dynamicRacingLine3D(false),
    m_gameMode(Session::Game::F1_25::GameMode::InvalidUnknown),
    m_ruleSet(Session::Game::F1_25::Ruleset::InvalidUnknown),
    m_timeOfDay(0),
    m_sessionLength(Session::Game::F1_25::Length::InvalidUnknown),
    m_speedUnitPlayer1(Player::Game::F1_25::SpeedUnit::InvalidUnknown),
    m_tempUnitPlayer1(Player::Game::F1_25::TempUnit::InvalidUnknown),
    m_speedUnitPlayer2(Player::Game::F1_25::SpeedUnit::InvalidUnknown),
    m_tempUnitPlayer2(Player::Game::F1_25::TempUnit::InvalidUnknown),
    ...
    m_carDamage(Session::Game::F1_25::EventRate4State::InvalidUnknown),
    m_carDamageRate(Session::Game::F1_25::EventRate3State::InvalidUnknown),
    m_collisions(Session::Game::F1_25::CollisionSetting::InvalidUnknown),
...
const Packet::Game::F1_25::LengthBytes Packet::Game::F1_25::SessionData::GetLength() const {

    return Packet::Game::F1_25::LengthBytes::SessionData;
...
#ifndef NDEBUG
void Packet::Game::F1_25::SessionData::Print() const {
...
void Packet::Game::F1_25::SessionData::BuildPacket(const char* packetInfo, Packet::Game::Helper* helper) {
