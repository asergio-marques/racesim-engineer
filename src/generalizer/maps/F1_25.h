...
namespace Generalizer {
	...
	namespace Maps {
		...
		struct F1_25 {
			...
			static const std::map<std::pair<Session::Game::F1_25::Formula, Session::Game::F1_25::Type>,
								std::pair<Session::Internal::RoundDetail, Session::Internal::TypeDetail>> SESSION_TYPE_MAP;
			static const std::map<Session::Game::F1_25::Weather, Session::Internal::WeatherType> WEATHER_TYPE_MAP;
