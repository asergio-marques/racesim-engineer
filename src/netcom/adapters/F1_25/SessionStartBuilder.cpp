...
NetCom::Adapter::F1_25::SessionStartBuilder::SessionStartBuilder() :
    m_enabled(false),
...
void NetCom::Adapter::F1_25::SessionStartBuilder::Start() {
...
void NetCom::Adapter::F1_25::SessionStartBuilder::CreateSessionPacket(const Packet::Game::F1_25::SessionData* gamePacket) {
...
void NetCom::Adapter::F1_25::SessionStartBuilder::AppendParticipantData(const Packet::Game::F1_25::ParticipantData* gamePacket) {
    ...
    if (m_waitingForParticipantData) {
        ...
        if (packet && m_enabled && gamePacket && gamePacket->GetHeader()) {
            ...
            for (uint8_t i = 0; i < gamePacket->GetNumActiveCars(); ++i) {
                ...
                bool ok = false;
                const Packet::Game::F1_25::ParticipantInfo rawInfo = gamePacket->GetParticipantInfo(i, ok);
                if (ok) {
...
void NetCom::Adapter::F1_25::SessionStartBuilder::AppendLapData(const Packet::Game::F1_25::LapData* gamePacket) {
    ...
    if (m_waitingForLapData && !m_waitingForParticipantData) {
        ...
        if (packet && m_enabled && gamePacket) {
            ...
            for (uint8_t i = 0; i < m_listParticipants.size(); ++i) {
                ...
                bool ok = false;
                const Packet::Game::F1_25::LapInfo rawInfo = gamePacket->GetLapInfo(i, ok);
                if (ok) {
...
Packet::Internal::SessionStart* NetCom::Adapter::F1_25::SessionStartBuilder::Finish() {
...
Packet::Internal::TimeTrialStart*
    NetCom::Adapter::F1_25::SessionStartBuilder::CreateTimeTrialStartPacket(const Packet::Game::F1_25::SessionData* gamePacket) {
...
Packet::Internal::PracticeStart*
    NetCom::Adapter::F1_25::SessionStartBuilder::CreatePracticeStartPacket(const Packet::Game::F1_25::SessionData* gamePacket) {
...
Packet::Internal::QualiStart*
    NetCom::Adapter::F1_25::SessionStartBuilder::CreateQualiStartPacket(const Packet::Game::F1_25::SessionData* gamePacket, uint8_t numClassifiedAtEnd) {
...
Packet::Internal::RaceStart*
    NetCom::Adapter::F1_25::SessionStartBuilder::CreateRaceStartPacket(const Packet::Game::F1_25::SessionData* gamePacket) {
...
void NetCom::Adapter::F1_25::SessionStartBuilder::ConvertTrackID(Packet::Internal::SessionStart* newPacket,
    const Packet::Game::F1_25::SessionData* gamePacket) {

    if (newPacket && gamePacket) {
        auto it = NetCom::Adapter::F1_25::DataConversionMaps::TRACK_ID_MAP.find(gamePacket->GetTrackId());
        if (it != NetCom::Adapter::F1_25::DataConversionMaps::TRACK_ID_MAP.end()) {
...
const std::string NetCom::Adapter::F1_25::SessionStartBuilder::ShortenDriverName(const char* originalName) {
...
NetCom::Adapter::F1_25::SessionStartBuilder::GetSingleParticipantData(const Packet::Game::F1_25::ParticipantInfo& rawInfo,
