...
void UserInterface::PixmapFactory::constructConverterMap() {
    ...
    m_converterMap.insert(UserInterface::Widget::StandardImage::FinishedInPitsBase,
            ":img/sectors/FinishedInPits.png");
    m_converterMap.insert(UserInterface::Widget::StandardImage::FinishedInvalidBase,
            ":img/sectors/FinishedInvalid.png");
    m_converterMap.insert(UserInterface::Widget::StandardImage::FinishedNotImprovementBase,
            ":img/sectors/FinishedNotImprovement.png");
    m_converterMap.insert(UserInterface::Widget::StandardImage::FinishedPersonalBestBase,
            ":img/sectors/FinishedPersonalBest.png");
    m_converterMap.insert(UserInterface::Widget::StandardImage::FinishedRetirementCompleteBase,
            ":img/sectors/FinishedRetirement.png");
    m_converterMap.insert(UserInterface::Widget::StandardImage::FinishedSessionFastestBase,
            ":img/sectors/FinishedSessionFastest.png");
    m_converterMap.insert(UserInterface::Widget::StandardImage::NotRunBase,
            ":img/sectors/NotRun.png");
    m_converterMap.insert(UserInterface::Widget::StandardImage::RunningInPitsBase,
            ":img/sectors/RunningInPits.png");
    m_converterMap.insert(UserInterface::Widget::StandardImage::RunningInvalidBase,
            ":img/sectors/RunningInvalid.png");
    m_converterMap.insert(UserInterface::Widget::StandardImage::RunningOnTrackBase,
            ":img/sectors/RunningOnTrack.png");
