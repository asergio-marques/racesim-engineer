...
void UserInterface::Screen::SinglePanelInterface::handleResizeEvent(const QSize newUsefulSize, const UserInterface::Screen::Resolution resolution) {

    m_panel->ResizePanel(newUsefulSize, resolution);
