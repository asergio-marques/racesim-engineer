...
void UserInterface::Screen::SinglePanelInterface::handleResizeEvent(const QSize newUsefulSize, const UserInterface::Style::Interface* style) {

    m_panel->ResizePanel(newUsefulSize, style);
